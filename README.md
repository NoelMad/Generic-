...
build a small Pokémon Storage System to learn Java generics in a smooth ramp:

start with a normal class (no generics)
refactor into a generic class (<T>)
add two generic types (<K, V>)
add a bounded generic (<T extends Pokemon>)
